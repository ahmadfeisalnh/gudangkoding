                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-3 portfolio-group no-padding">
                                                ...
                                                $tampil = $db->query("SELECT * From produk  where kategori='Tradisional' order by nama asc") or die ($db->error);
                                                ...
                                                <div class="col-md-3 portfolio-item margin-bottom-20 code">
                                                    <div>
                                                        <figure>
                                                            ...
                                                            <hr>
                                                            <a class="btn btn-success" href="detailproduk.php?id=<?php echo $data[0]; ?>"> Beli &raquo;</a>
                                                            </figcaption>
                                                        </figure>
                                                    </div>
                                                </div>
