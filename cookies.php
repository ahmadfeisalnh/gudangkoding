                        ...
                        <div class="container">
                            <div class="row margin-vert-30"></div>
                                <h1>Cookies</h1>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-3 portfolio-group no-padding">
                                                <?php

                                                $tampil = $db->query("SELECT * From produk  where kategori='Cookies' order by nama asc") or die ($db->error);
                                                while($data = mysqli_fetch_array($tampil)){
                                                ?>
                                                <div class="col-md-3 portfolio-item margin-bottom-20 code">
                                                    <div>
                                                        <figure>
                                                            <figcaption>
                                                            ...
                                                            <hr>
                                                            <a class="btn btn-success" href="detailproduk.php?id=<?php echo $data[0]; ?>"<i class="fa fa-shopping-cart"></i> Beli &raquo;</a>
                                                            </figcaption>
                                                        </figure>
                                                    </div>
                                                </div>
